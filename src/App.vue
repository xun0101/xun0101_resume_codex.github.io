      ...
      <section id="hero" class="hero section">
        ...
        <div class="hero__content" data-reveal>
          ...
          <div class="hero__actions">
            ...
            <a
              class="button button--secondary button--icon button--github"
              href="https://github.com/xun0101"
              target="_blank"
              rel="noreferrer"
            ...
            >
              <svg viewBox="0 0 16 16" aria-hidden="true" class="github-icon">
                <path
                  ...
                  2.2.82a7.57 7.57 0 0 1 4 0c1.53-1.04 2.2-.82 2.2-.82.44 1.1.16 1.92.08 2.12.51.56.82 1.27.82 2.15
